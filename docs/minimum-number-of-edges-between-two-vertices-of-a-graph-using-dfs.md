...
> 原文:[https://www . geeksforgeeks . org/使用 dfs 的图的两个顶点之间的最小边数/](https://www.geeksforgeeks.org/minimum-number-of-edges-between-two-vertices-of-a-graph-using-dfs/)

给定一个无向图 **G(V，E)** ，其中有 **N** 个顶点和 **M** 条边。我们需要找到给定顶点对之间的最小边数 **(u，v)** 。
我们已经使用 [BFS 方法](https://www.geeksforgeeks.org/minimum-number-of-edges-between-two-vertices-of-a-graph/)讨论了这个问题，这里我们将使用 DFS 方法。

**示例:**

> **输入:**对于下面给定的图，求顶点对(0，4)
> 之间的最小边数
> 
...
**方法:**在这种方法中，我们将以 [DFS](https://www.geeksforgeeks.org/depth-first-traversal-for-a-graph/) 的方式遍历图，从给定的顶点开始，探索从该顶点到我们的目的顶点的所有路径。

我们将使用两个变量，**边数**和**最小边数**。探索所有路径时，在这些顶点之间，**边数**将存储其中边总数的计数，如果边数小于最小边数，我们将更新**最小边数**。
